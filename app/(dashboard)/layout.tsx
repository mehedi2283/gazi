...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-slate-50/50 text-slate-800">
      <aside className="relative sticky top-0 z-20 flex h-screen w-[272px] shrink-0 flex-col overflow-y-auto border-r border-slate-200/50 bg-white/70 p-5 backdrop-blur-2xl">
